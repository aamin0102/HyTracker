...
def image_storage(aug_image, copy_gt, training_image_count, path):
    ...
    image_path = os.path.join(path, 'vis_{:010d}.jpg'.format(training_image_count + 1))
    cv2.imwrite(image_path, aug_image)
    text_path = os.path.join(path, 'vis_{:010d}.txt'.format(training_image_count + 1))
...
if __name__ == "__main__":
    ...
    validation_dataset_directory = "D:\\hsi_2023_dataset\\validation\\hsi\\vis"
    ...
    for i in range(len(training_videos)):
        ...
        number_of_class = class_name["training_"+"vis_"+training_videos[i]]
    ...
    for i in range(len(validation_videos)):
        ...
        number_of_class = class_name["validation_vis_" + validation_videos[i]]
