...
msbabs_16 = HAS_BS(in_channels=16)
pretrained_ = torch.load("../weights/band16_checkpoint.pth")
msbabs_16.load_state_dict(pretrained_)
...
def band_selection_16(image, bbox):
    ...
    crop_img, band_order = msbabs_16(crop_img.float())
    return band_order
