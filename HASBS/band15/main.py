...
from HASBS.band15.dataset import ReconDataset
from HASBS.has_bs.has_bs import HAS_BS

# Load your custom dataset
path = "D:\\hsi_2023_dataset\\training\\hsi\\rednir"
weight_path = "../weights"
checkpoint_path = os.path.join(weight_path, "band15_checkpoint.pth")
dataset = ReconDataset(path)

# Define your MSE loss function
criterion = nn.MSELoss()
# Move model to GPU
model = HAS_BS(in_channels=15).cuda()
